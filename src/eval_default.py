...
query = """INSERT OVERWRITE TABLE result_default
...
JOIN customers_default c ON o.customer_key = c.customer_key
...
spark.sql("""CREATE TABLE IF NOT EXISTS result_default (
